...
VERTICAL_PROFILE_PRESETS: dict[str, tuple[str, ...]] = {
    ...
    'retail': (
        'app.retail.customers',
        'app.retail.firms',
        'app.retail.service_desk',
        'app.retail.personnel',
        'app.retail.payroll',
        'app.retail.finance',
        'app.retail.sales',
        'int.whatsapp_bridge',
    ...
    'healthcare': (
        'app.healthcare.customers',
        'app.healthcare.appointments',
        'app.healthcare.campaigns',
        'int.whatsapp_bridge',
        'int.media',
    ),
    'nonprofit': (
        'app.nonprofit.members',
        'app.nonprofit.firms',
        'app.nonprofit.campaigns',
        'int.whatsapp_api',
        'int.media',
    ),
}
...
PROFILE_APPS: tuple[dict, ...] = (
    ...
    },
    {
        ...
        'category': 'iliskiler',
        'name': 'Müşteri & Marka',
        'summary': 'Ajans müşteri kartları ve marka bilgileri.',
        'icon': 'sparkles',
        'hub_url_name': 'customers',
        'access_perm': 'access.contact',
        'platform_modules': ('contact',),
    ...
    },
    {
        ...
        'category': 'proje',
        'name': 'Freelancer Ağı',
        'summary': 'Taşeron, tasarımcı ve çözüm ortağı kadrosu.',
        'icon': 'user-plus',
        'hub_url_name': 'solution_network',
        'access_perm': 'access.contact',
        'platform_modules': ('contact',),
        'platform_particles': ('p.contact.freelancers',),
        'sort': 30,
    },
    {
        ...
        'category': 'iliskiler',
        'name': 'Firma Rehberi',
        'summary': 'Potansiyel müşteri firmaları ve Maps.',
        'icon': 'building-2',
        'hub_url_name': 'contact_firmalar',
        'access_perm': 'access.contact',
        'platform_modules': ('contact',),
    ...
    },
    {
        ...
        'summary': 'Teklif, proje bedeli ve satış takibi.',
        'icon': 'trending-up',
        'hub_url_name': 'sales_lead_dashboard',
        'access_perm': 'access.accounting',
        'platform_modules': ('accounting',),
    ...
    },
    {
        ...
        'category': 'finans',
        'name': 'Ajans Finans',
        'summary': 'Gelir-gider, retainer tahsilat özeti.',
        'icon': 'receipt',
        'hub_url_name': 'accounting_finance',
        'access_perm': 'access.accounting',
        'platform_modules': ('accounting',),
    ...
    },
    {
        ...
        'summary': 'Müşteri ve lead toplu WhatsApp.',
    ...
    # --- Perakende (özet set) ---
    {
        'slug': 'app.retail.customers',
        'vertical': 'retail',
        'category': 'iliskiler',
        'name': 'Müşteri & Bayi',
        'summary': 'Mağaza ve bayi müşteri kartları.',
        'icon': 'users',
        'hub_url_name': 'customers',
        'access_perm': 'access.contact',
        'platform_modules': ('contact',),
    ...
    {
        'slug': 'app.retail.firms',
        'vertical': 'retail',
        'category': 'iliskiler',
        'name': 'Tedarikçi Rehberi',
        'summary': 'Firma ve tedarikçi kayıtları.',
        'icon': 'building-2',
        'hub_url_name': 'contact_firmalar',
        'access_perm': 'access.contact',
        'platform_modules': ('contact',),
    ...
    {
        'slug': 'app.retail.service_desk',
        'vertical': 'retail',
        'category': 'operasyon',
        'name': 'Mağaza Destek',
        'summary': 'Şube/mağaza talep ve iş emirleri.',
        'icon': 'headphones',
        'hub_url_name': 'dashboard',
        'access_perm': 'access.services',
        'platform_modules': ('services',),
    ...
    {
        'slug': 'app.retail.personnel',
        'vertical': 'retail',
        'category': 'operasyon',
        'name': 'Personel',
        'summary': 'Mağaza personeli ve vardiya kadrosu.',
        'icon': 'id-card',
        'hub_url_name': 'accounting_personnel',
        'access_perm': 'access.accounting',
        'platform_modules': ('accounting',),
    ...
    {
        'slug': 'app.retail.payroll',
        'vertical': 'retail',
        'category': 'finans',
        'name': 'Maaş & Avans',
        'summary': 'Personel ödeme döngüsü.',
        'icon': 'wallet',
        'hub_url_name': 'accounting_payroll',
        'access_perm': 'access.accounting',
        'platform_modules': ('accounting',),
    ...
    {
        'slug': 'app.retail.finance',
        'vertical': 'retail',
        'category': 'finans',
        'name': 'Gelir & Gider',
        'summary': 'Mağaza kasa hareketleri.',
        'icon': 'receipt',
        'hub_url_name': 'accounting_finance',
        'access_perm': 'access.accounting',
        'platform_modules': ('accounting',),
    ...
    {
        'slug': 'app.retail.sales',
        'vertical': 'retail',
        'category': 'finans',
        'name': 'Satış Kayıtları',
        'summary': 'Perakende ve bayi satışları.',
        'icon': 'badge-dollar-sign',
        'hub_url_name': 'sales_lead_dashboard',
        'access_perm': 'access.accounting',
        'platform_modules': ('accounting',),
    ...
    # --- Sağlık ---
    {
        'slug': 'app.healthcare.customers',
        'vertical': 'healthcare',
        'category': 'iliskiler',
        'name': 'Hasta Kayıtları',
        'summary': 'Hasta kartları ve iletişim.',
        'icon': 'heart-pulse',
        'hub_url_name': 'customers',
        'access_perm': 'access.contact',
        'platform_modules': ('contact',),
    ...
    {
        'slug': 'app.healthcare.appointments',
        'vertical': 'healthcare',
        'category': 'operasyon',
        'name': 'Randevu & Servis',
        'summary': 'Randevu ve klinik işlem takibi (yardım masası).',
        'icon': 'calendar',
        'hub_url_name': 'dashboard',
        'access_perm': 'access.services',
        'platform_modules': ('services',),
    ...
    {
        'slug': 'app.healthcare.campaigns',
        'vertical': 'healthcare',
        'category': 'iletisim',
        'name': 'Hatırlatma Mesajları',
        'summary': 'Randevu hatırlatma WhatsApp.',
        'icon': 'megaphone',
        'hub_url_name': 'outreach_hub',
        'access_perm': 'access.outreach',
        'platform_modules': ('outreach',),
    ...
    # --- STK ---
    {
        'slug': 'app.nonprofit.members',
        'vertical': 'nonprofit',
        'category': 'iliskiler',
        'name': 'Üye & Gönüllü',
        'summary': 'Üye kayıtları ve iletişim.',
        'icon': 'hand-heart',
        'hub_url_name': 'customers',
        'access_perm': 'access.contact',
        'platform_modules': ('contact',),
    ...
    {
        'slug': 'app.nonprofit.firms',
        'vertical': 'nonprofit',
        'category': 'iliskiler',
        'name': 'Kurum Rehberi',
        'summary': 'Paydaş ve kurum kayıtları.',
        'icon': 'building-2',
        'hub_url_name': 'contact_firmalar',
        'access_perm': 'access.contact',
        'platform_modules': ('contact',),
    ...
    {
        'slug': 'app.nonprofit.campaigns',
        'vertical': 'nonprofit',
        'category': 'iletisim',
        'name': 'Duyuru Kampanyaları',
        'summary': 'Toplu bilgilendirme mesajları.',
        'icon': 'megaphone',
        'hub_url_name': 'outreach_hub',
        'access_perm': 'access.outreach',
        'platform_modules': ('outreach',),
        ...
        if item:
            ...
            for p in item.get('platform_particles', ()):
                if p not in out:
                    out.append(p)
            continue
        if slug.startswith('p.') or slug.startswith('integration_') or slug in (
...
def collapse_platform_to_profile_slugs(raw: list[str], vertical: str) -> list[str]:
    ...
    legacy_platform = {
        'contact', 'services', 'accounting', 'outreach', 'agency_suite', 'tools',
